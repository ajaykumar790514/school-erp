...
$route['admin-profile'] = 'teacher/profile';
...
//class-teacher-student-leave-request
$route['class-teacher-student-leave-request'] = 'class_teacher/teacher_student_leave_request';
$route['class-teacher-student-leave-request/(:any)'] = 'class_teacher/teacher_student_leave_request/$1';
$route['class-teacher-student-leave-request/(:any)/(:any)'] = 'class_teacher/teacher_student_leave_request/$1/$2';

//section-head-student-leave-request
$route['section-head-student-leave-request'] = 'section_head/teacher_student_leave_request';
$route['section-head-student-leave-request/(:any)'] = 'section_head/teacher_student_leave_request/$1';
$route['section-head-student-leave-request/(:any)/(:any)'] = 'section_head/teacher_student_leave_request/$1/$2';
//principal-student-leave-request
$route['principal-student-leave-request'] = 'principal/teacher_student_leave_request';
$route['principal-student-leave-request/(:any)'] = 'principal/teacher_student_leave_request/$1';
$route['principal-student-leave-request/(:any)/(:any)'] = 'principal/teacher_student_leave_request/$1/$2';


//teacher-student-timetable
$route['teacher-student-timetable/(:num)'] = 'teacher/teacher_student_timetable/view/$1';
$route['teacher-student-timetable/(:any)'] = 'teacher/teacher_student_timetable/$1';
$route['teacher-student-timetable/(:any)/(:any)'] = 'teacher/teacher_student_timetable/tb/$1/$2';

//academic-student-timetable
$route['academic-student-timetable/(:num)'] = 'academic/academic_student_timetable/view/$1';
$route['academic-student-timetable/(:any)'] = 'academic/academic_student_timetable/$1';
$route['academic-student-timetable/(:any)/(:any)'] = 'academic/academic_student_timetable/tb/$1/$2';

//academic-student-timetable
$route['classteacher-student-timetable/(:num)'] = 'class_teacher/classteacher_student_timetable/view/$1';
$route['classteacher-student-timetable/(:any)'] = 'class_teacher/classteacher_student_timetable/$1';
$route['classteacher-student-timetable/(:any)/(:any)'] = 'class_teacher/classteacher_student_timetable/tb/$1/$2';
//sectionhead-student-timetable
$route['sectionhead-student-timetable/(:num)'] = 'section_head/sectionhead_student_timetable/view/$1';
$route['sectionhead-student-timetable/(:any)'] = 'section_head/sectionhead_student_timetable/$1';
$route['sectionhead-student-timetable/(:any)/(:any)'] = 'section_head/sectionhead_student_timetable/tb/$1/$2';

//principal-student-timetable
$route['principal-student-timetable/(:num)'] = 'principal/principal_student_timetable/view/$1';
$route['principal-student-timetable/(:any)'] = 'principal/principal_student_timetable/$1';
$route['principal-student-timetable/(:any)/(:any)'] = 'principal/principal_student_timetable/tb/$1/$2';

//library-student-timetable
$route['library-student-timetable/(:num)'] = 'library/library_student_timetable/view/$1';
$route['library-student-timetable/(:any)'] = 'library/library_student_timetable/$1';
$route['library-student-timetable/(:any)/(:any)'] = 'library/library_student_timetable/tb/$1/$2';