      ...
      <div class="col-12">
            <div class="card">
              ...
              <h3 class="card-title float-right ml-2">
                <a href="<?=base_url();?>transport-data" class="btn btn-danger btn-sm"><i class="fas fa-backward"></i>   Back</a>
                </h3>
                <h3 class="card-title float-right mt-0">
                <button class="btn-sm btn btn-primary" href="javascript:void(0)" data-toggle="modal" data-target="#showModal" data-whatever="Add Conductor" data-url="<?=$new_url?>" >Add Conductor</button>
                </h3>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-12 col-xl-12 pt-1">
