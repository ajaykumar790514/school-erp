    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <a href="<?=base_url();?>section-head-profile" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <div class="media-body">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>section-head-notice" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>section-head-upload-notes" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>section-head-upload-hw" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>section-head-student-gate-pass" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>section-head-student-master" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>sectionhead-student-attendance-register" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>section-wise-period-master" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>section-time-table" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>section-head-student-leave-request" class="nav-link">
