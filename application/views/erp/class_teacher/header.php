  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light fixed-top myheader" style="height: 57px;">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?=base_url();?>section-head-data" class="nav-link">Home</a>
      </li>
    </ul>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <a href="<?=base_url();?>class-teacher-profile" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <div class="media-body">
          ...
          <div class="dropdown-divider"></div>
          <a href="<?=base_url();?>teacher-logout" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <div class="media-body">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>class-teacher-notice" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>class-teacher-upload-notes" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>class-teacher-upload-hw" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>class-teacher-student-gate-pass" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>class-teacher-student-master" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>class-subject-topic-master" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>class-student-attendance-register" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>view-class-teacher-time-table" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>class-teacher-student-leave-request" class="nav-link">
