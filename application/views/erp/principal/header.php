  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light fixed-top myheader" style="height: 57px;">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?=base_url();?>principal-data" class="nav-link">Home</a>
      </li>
    </ul>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <a href="<?=base_url();?>principal-profile" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <div class="media-body">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>subject-teacher-mapping" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>class-teacher-mapping" class="nav-link">
            <i class="fa fa-users" aria-hidden="true"></i>
              <p>
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>section-head-mapping" class="nav-link">
            <i class="fa fa-users" aria-hidden="true"></i>
              <p>
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>role-assign-master" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>principal-student-gate-pass" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>principal-student-master" class="nav-link">
            <i class="fas fa-user-graduate"></i>
              <p>
                Student Master
              </p>
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>principal-student-attendance-register" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>principal-section-time-table" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>principal-student-marks-upload" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>student-marksheet-individual" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>student-marksheet" class="nav-link">
            <i class="fa-solid fa-file-arrow-down"></i>
              <p>
              Student Marksheet
              </p>
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>principal-student-leave-request" class="nav-link">
