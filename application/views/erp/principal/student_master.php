          ...
          <div class="col-12">
            <div class="card">
              ...
              <h3 class="card-title float-right">
                <a href="<?=base_url();?>principal-data" class="btn btn-danger  btn-sm"><i class="fas fa-backward"></i>   Back</a>
                </h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body table-responsive p-0 pb-3">
                <table class="table table-hover text-nowrap  table-bordered">
                  ...
                  <tr>
                    ...
                    <td><a href="<?=base_url('principal-student-master/section/'.$s->sec_id);?>" class="btn btn-success btn-sm " style="width:60px"><?=$s->totalregister;?></a></td>
                    <td><?=$s->class_teacher_name;?></td>
                    <td><?=$s->section_head_name;?></td>
                    <td><a href="<?=base_url('principal-student-timetable/'.$s->sec_id);?>" class="btn btn-danger btn-sm " >View Time Table</a></td>
                  </tr>
                  <?php $i++;};?>
                  </tbody>
                </table>
