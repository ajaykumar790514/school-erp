  ...
  <div class="content-wrapper pt-4 pb-5">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <form action="<?=base_url('student-marksheet-individual');?>" method="POST">
        <div class="row mb-2">
          <div class="col-sm-6">
          ...
          <select name="section_id" id="" class="form-control input-sm" required>
         ...
         <?php endforeach;?>    
          ...
          <div class="col-sm-3 mt-3">
            ...
            <select name="exam_id" id="" class="form-control input-sm" required>
          ...
          <div class="col-sm-3 mt-3">
            ...
            <input type="date" class="form-control input-sm" name="date" value="<?=$date;?>" required>
          </div>
          <div class="col-sm-3 mt-5">
            <button type="submit" class="btn btn-primary btn-sm ">Submit</button>
            <a href="<?=base_url();?>principal-data" class="btn btn-danger  btn-sm ml-4"><i class="fas fa-backward"></i>   Back</a>
          </div>
           ...
           <table width="100%" style="width:100%; margin-top:-5px; color:#000000; font-size:16px;margin-bottom:0.8rem" border="0">
            ...
            <?php $Tmarks = $Totalmm = 0; foreach($sst_data as $sst): ?>
             <tr>
              ...
              <?php 
                $mark = $this->principal_model->get_student_marks($stu->id,$section_id,$sst->id,$exam_id); 
                $stumark =  $mark->marks ?? 'NA';
               $Totalmm = $Totalmm + $exam_data->max_marks;
               $Tmarks = $Tmarks + $stumark;
               $per = round((($Tmarks/$Totalmm)*100),2)
              ?>
              <td style="text-align:center;"><?=$exam_data->max_marks;?></td>
            ...
            <td style="text-align:center;"><b><?=$Tmarks;?></b></td>
            </tr>
             <tr>
              ...
              <td style="text-align:center;" colspan="2" >&nbsp;&nbsp;<b><?=$per;?> %</b></td>
               ...
               <tr>
                <td >&nbsp;&nbsp;<b>Date: &nbsp;&nbsp;</b></td>
                <td style="text-align:center;" colspan="2" >&nbsp;&nbsp;<b><?=$newDate = date("d", strtotime($date));?><sup>th</sup><?=$newDate = date(" M Y ", strtotime($date));?></b> </td>
              </tr>
            </table>
            <br>
