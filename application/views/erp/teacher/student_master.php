              ...
              <div class="card-body table-responsive p-0 pb-3">
                <table class="table table-hover text-nowrap  table-bordered">
                  ...
                  <tr>
                    ...
                    <td><a href="<?=base_url('teacher-student-master/section/'.$s->sec_id);?>" class="btn btn-success btn-sm " style="width:60px"><?=$count;?></a></td>
                    <td><?=$s->class_teacher_name;?></td>
                    <td><?=$s->section_head_name;?></td>
                    <td><a href="<?=base_url('teacher-student-timetable/'.$s->sec_id);?>" class="btn btn-danger btn-sm " >View Time Table</a></td>
                  </tr>
                  <?php $i++;};?>
                  </tbody>
                </table>
