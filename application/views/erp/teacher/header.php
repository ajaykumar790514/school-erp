  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light fixed-top myheader" style="height: 57px;">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?=base_url();?>teacher-data" class="nav-link">Home</a>
      </li>
    </ul>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>upload-notes" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>upload-hw" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>teacher-student-gate-pass" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>teacher-student-master" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>teacher-student-attendance-register" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>view-teacher-time-table" class="nav-link">
            <i class="fa-solid fa-calendar-days"></i>
              <p>
            My Time Table
              </p>
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>teacher-student-marks-upload" class="nav-link">
