  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light fixed-top myheader" style="height: 57px;">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?=base_url();?>hrm-data" class="nav-link">Home</a>
      </li>
    </ul>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <a href="<?=base_url();?>hrm-profile" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <div class="media-body">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>teacher-information" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>room-master" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>role-master" class="nav-link">
          ...
          <li class="nav-item">
           ...
           <li class="nav-item">
            <a href="<?=base_url();?>working-hour-master" class="nav-link">
