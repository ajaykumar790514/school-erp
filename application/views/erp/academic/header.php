...
<label for="" class="success"></label>
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light fixed-top myheader" style="height: 57px;">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?=base_url();?>academic-data" class="nav-link">Home</a>
      </li>
    </ul>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <a href="<?=base_url();?>academic-profile" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <div class="media-body">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4 bg-info">
    <!-- Brand Logo -->
    <a href="<?=base_url();?>common-dashboard" class="brand-link">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>academic-notice" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>class-master" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>section-master" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>section-allot-master" class="nav-link">
            <i class="fas fa-user-graduate"></i>
              <p>
                   Student Section Allot
              </p>
            </a>
          </li>
          <li class="nav-item">
            <a href="<?=base_url();?>academic-student-master" class="nav-link">
            <i class="fas fa-user-graduate"></i>
              <p>
                   Student Master
              </p>
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>holiday-master" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>category-master" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>academic-student-attendance-register" class="nav-link">
            ...
            <li class="nav-item">
            <a href="<?=base_url();?>exam-master" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>student-marks-upload" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>student-remarks-upload" class="nav-link">
            <i class="fas fa-check-circle"></i>
              <p>
                  Student Remarks Upload
              </p>
            </a>
          </li> 
          <li class="nav-item">
            <a href="<?=base_url();?>subject-master" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>subject-topic-master" class="nav-link">
            <i class="fas fa-book"></i>
              <p>
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>academic-section-wise-period-master" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>academic-calendar" class="nav-link">
