      ...
      <div class="col-12">
            <div class="card">
              ...
              <h3 class="card-title float-right">
                ...
                <h3 class="card-title float-right">
                <button class="float-right btn btn-primary btn-sm mr-1" href="javascript:void(0)" data-toggle="modal" data-target="#showModal" data-whatever="Add <?=$title;?>" data-url="<?=$new_url?>" >Add <?=$title;?></button>
                </h3>
