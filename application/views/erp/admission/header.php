  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light fixed-top myheader" style="height: 57px;">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?=base_url();?>admission-data" class="nav-link">Home</a>
      </li>
    </ul>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>admission-system" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>admission-section-allot" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>concession-master" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>section-wise-student-master" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>student-document-master" class="nav-link">
              <i class="fas fa-user-graduate"></i>
              <p>
                Student  Document Master
              </p>
            </a>
          </li>
          <li class="nav-item">
            <a href="<?=base_url();?>student-update-master" class="nav-link">
              <i class="fas fa-user-graduate"></i>
              <p>
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>admission-student-attendance-register" class="nav-link">
