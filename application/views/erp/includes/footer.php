...
<script src="<?=base_url()?>assets/extensions/sweetalert2.all.js" type="text/javascript"></script>
<!-- Bootstrap 4 -->
...
<script src="<?=base_url()?>assets/extensions/toastr.min.js" type="text/javascript"></script>
    <script src="<?=base_url()?>assets/extensions/toastr.js" type="text/javascript"></script>
