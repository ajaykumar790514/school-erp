  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light fixed-top myheader" style="height: 57px;">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?=base_url();?>accounts-data" class="nav-link">Home</a>
      </li>
    </ul>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <a href="<?=base_url();?>accounts-profile" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <div class="media-body">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>academic-year-master" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>fee-type-master" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>fee-head-master" class="nav-link">
           ...
           <li class="nav-item">
            <a href="<?=base_url();?>fee-scheme-master" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>fee-structure" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>view-fee-structure" class="nav-link">
            <i class="fa-solid fa-inr"></i>
              <p>
                View Fee Structure
              </p>
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>fee-collection" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>fee-collection-report" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>student-fee-collection-report" class="nav-link">
            <i class="fa-solid fa-hand-holding-dollar"></i>
              <p>
              Student Wise Report
              </p>
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>student-fee-defaulter-list" class="nav-link">
            <i class="fa-solid fa-hand-holding-dollar"></i>
              <p>
          ...
          <li class="nav-item">
            <a href="<?=base_url();?>section-wise-fee-collection-report" class="nav-link">
            <i class="fa-solid fa-hand-holding-dollar"></i>
              <p>
              Section Wise Report
              </p>
