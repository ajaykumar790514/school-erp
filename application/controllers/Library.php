...
class Library extends Inst {
    ...
    public function profile($action=null,$p1=null,$p2=null,$p3=null)
    {
        ...
        $this->load->view('erp/library/header',$data);
        $this->load->view('erp/library/my_profile',$data);
        $this->load->view('erp/library/footer');
        break;
        case 'edit-image':
            $return['res'] = 'error';
...
}else
{
  ...
  public function library_student_timetable($action=null,$p1=null,$p2=null,$p3=null)
   { 
       switch ($action) {
           case 'view':
       $data['menu_id'] = $this->uri->segment(2);
       ...
       $data['search']           = $this->input->post('search');
       $this->load->view('erp/library/header',$data);
       $this->load->view('erp/library/section_timetable_master',$data);
       $this->load->view('erp/library/footer');
       break;
       case 'tb':
           $id=$_SESSION['MUserId'];
           ...
           $page                       = 'erp/library/tb_timetable_section';
           $this->load->view($page, $data); 
           break;
