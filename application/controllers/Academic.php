...
public function calendar($action=null,$p1=null,$p2=null,$p3=null)
{
   ...
   public function academic_student_timetable($action=null,$p1=null,$p2=null,$p3=null)
   { 
       switch ($action) {
           case 'view':
       $data['menu_id'] = $this->uri->segment(2);
       ...
       $data['search']           = $this->input->post('search');
       $this->load->view('erp/academic/header',$data);
       $this->load->view('erp/academic/section_timetable_master',$data);
       $this->load->view('erp/academic/footer');
       break;
       case 'tb':
           $id=$_SESSION['MUserId'];
           $data['section']=$p1;
           $data['section_name']   = $this->academic_model->view_data_id('section_master',$p1);
           $data['period']         = $this->academic_model->view_period_data('section_periods');
           $page                       = 'erp/academic/tb_timetable_section';
           $this->load->view($page, $data); 
           break;
